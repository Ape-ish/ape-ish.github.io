  ...
  return (
    <footer id="contact" className="section-panel" style={{
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'clamp(36px,6vw,80px)', justifyContent: 'space-between', alignItems: 'flex-end' }}>
        <div>
          <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, letterSpacing: '0.2em', color: '#666', marginBottom: 'clamp(20px,3vh,30px)' }}>
            // ROUTE_CONTACT
          </div>
          <a
          ...
          <div style={{ display: 'flex', gap: 24, marginTop: 'clamp(26px,4vh,38px)', fontFamily: "'JetBrains Mono', monospace", fontSize: 12, letterSpacing: '0.1em' }}>
            <a href="https://github.com/Ape-ish" target="_blank" rel="noopener" className="social-link" style={{ color: '#888' }}>GITHUB ↗</a>
            <a href="https://www.linkedin.com/in/curtiswhipple/" target="_blank" rel="noopener" className="social-link" style={{ color: '#888' }}>LINKEDIN ↗</a>
          </div>
        </div>
        ...
        <div style={{ textAlign: 'right', fontFamily: "'JetBrains Mono', monospace" }}>
          ...
          <div style={{ fontSize: 11, color: '#555', marginTop: 14, letterSpacing: '0.1em' }}>
            {clock}
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        borderTop: '1px solid rgba(255,255,255,0.07)',
        fontFamily: "'JetBrains Mono', monospace", fontSize: 10.5, letterSpacing: '0.16em', color: '#555',
      }}>
