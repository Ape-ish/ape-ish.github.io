  ...
  return (
    <section id="stack" className="section-panel" style={{
      ...
      <div style={{
        ...
        {/* frameworks */}
        <div style={{ background: 'rgba(5,5,5,0.1)', padding: 'clamp(26px,3vw,40px)' }}>
          <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: 'clamp(22px,3vh,34px)' }}>
            ...
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: 'hsl(180, 100%, 70%)' }}>[A]</span>
          </div>
        ...
        <div style={{ background: 'rgba(5,5,5,0.1)', padding: 'clamp(26px,3vw,40px)' }}>
          <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: 'clamp(22px,3vh,34px)' }}>
            ...
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: 'hsl(180, 100%, 70%)' }}>[B]</span>
          </div>
          <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 12.5 }}>
            {[
      ...
      <div style={{ marginTop: 1, background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.08)', borderTop: 'none' }}>
        <div style={{
          background: 'rgba(5,5,5,0.1)', padding: 'clamp(26px,3vw,40px)',
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 16 }}>
            ...
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: 'hsl(180, 100%, 70%)' }}>[C]</span>
          </div>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, fontFamily: "'JetBrains Mono', monospace", fontSize: 12 }}>
            ...
            {certsSecondary.map((c) => (
              <span key={c} style={{ border: '1px solid rgba(255,255,255,0.14)', padding: '9px 15px', color: 'hsl(180, 100%, 70%)' }}>{c}</span>
            ))}
          </div>
        </div>
      </div>
